<?php
// src/Command/FetchSummonerJsonCommand.php
...
#[AsCommand(
    name: 'app:summoners:fetch-json',
    description: 'Récupère les JSON des sorts (summoner.json) pour toutes les versions × toutes les langues.'
)]
final class FetchSummonerJsonCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title(sprintf('Fetch summoner.json — %d version(s) × %d langue(s)', count($versions), count($languages)));
