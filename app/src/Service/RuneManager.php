...
final class RuneManager{
     ...
     */
    public function getRunes(string $version, string $lang): array
    {
        return $this->riotManager->getJson($version, $lang, 'runesReforged');
    }
     ...
     */
    public function getRuneByName(string $name, string $version, string $lang): array{
        return $this->riotManager->getDataByKey($name, $version, $lang, 'key', 'runesReforged', true);
    }
     ...
     */
    public function getRunesImages(string $version, string $lang, bool $force = false, array $items = []): array
    {
        return $this->riotManager->getImages($version, $lang, $force, 'runesReforged', 'icon', $items);
    }
     ...
     */
    public function getRuneImage(string $name, string $version, array $dir = [], bool $force = false, string $lang = ''):string {
        return $this->riotManager->getImage($name, $version, $dir, $force, $lang,  'runesReforged', 'https://ddragon.leagueoflegends.com/cdn/img/');
    }
