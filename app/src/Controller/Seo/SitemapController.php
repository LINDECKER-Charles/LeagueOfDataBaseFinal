...
final class SitemapController extends AbstractController
{
    ...
    {
        return $this->xml(
            $this->builder->indexXml($request->getSchemeAndHttpHost()),
            self::CACHE_MAX_AGE,
        );
    }
    ...
    {
        return $this->xml(
            $this->builder->latestXml($request->getSchemeAndHttpHost()),
            self::CACHE_MAX_AGE,
        );
    }
    ...
    #[Route(
        ...
        name: 'app_sitemap_version',
        requirements: ['version' => VersionManager::VERSION_PATTERN],
        methods: ['GET'],
    )]
