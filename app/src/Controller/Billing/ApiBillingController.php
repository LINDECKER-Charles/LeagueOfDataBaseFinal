...
final class ApiBillingController extends AbstractController
{
    ...
    public function pack(Request $request): RedirectResponse
    {
        ...
        return $this->redirectToStripe(
            fn (): string => $this->checkout->packSession($key->getUser(), $pack)
        );
    }
    ...
    public function plan(Request $request): RedirectResponse
    {
        ...
        return $this->redirectToStripe(
            fn (): string => $this->checkout->planSession($key->getUser(), $plan)
        );
    }
    ...
    private function guardedActiveKey(Request $request): ApiKey|RedirectResponse
    {
        ...
        return $this->apiKeys->findActiveByUser($this->currentUser())
