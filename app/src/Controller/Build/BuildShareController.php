 ...
 */
final class BuildShareController extends AbstractPageController
{
    ...
    public function show(string $token): Response
    {
        ...
        ['version' => $currentVersion, 'lang' => $lang] = $this->pageContext->selection();
        ...
        $version = BuildViewAssembler::renderVersion($build, $currentVersion);

        return $this->render('build/show.html.twig', [
            'client' => $this->clientData(),
            'build' => $build,
            'vm' => $this->assembler->assemble($build, $version, $currentVersion, $lang),
            'version' => $version,
