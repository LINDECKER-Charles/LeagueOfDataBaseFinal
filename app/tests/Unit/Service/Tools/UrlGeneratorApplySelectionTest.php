...
final class UrlGeneratorApplySelectionTest extends TestCase
{
    ...
    public function testVersionedPathSegmentIsRewrittenNotQueried(): void
    {
        self::assertSame(
            ...
            $this->urls->applySelection(
                'http://localhost:8080/10.13.1/champion/Akali?lang=en_US',
                '14.9.1',
                'en_US',
            ),
        );
    ...
    public function testVersionedListPathSegmentIsRewritten(): void
    {
        self::assertSame(
            ...
            $this->urls->applySelection(
                'http://localhost:8080/10.13.1/champions?lang=en_US',
                '14.9.1',
                'fr_FR',
            ),
        );
    ...
    public function testQueryVersionIsReplacedOnCleanPath(): void
    {
        self::assertSame(
            ...
            $this->urls->applySelection(
                'http://localhost:8080/champion/Akali?version=10.13.1&lang=en_US',
                '14.9.1',
                'fr_FR',
            ),
        );
    ...
    public function testNumericResourceIdIsNotMistakenForAVersionSegment(): void
    {
        ...
        self::assertSame(
            ...
            $this->urls->applySelection(
                'http://localhost:8080/object/1001?version=10.13.1&lang=en_US',
                '14.9.1',
                'en_US',
            ),
        );
    ...
    public function testUnrelatedQueryAndFragmentArePreserved(): void
    {
        self::assertSame(
            ...
            $this->urls->applySelection(
                'http://localhost:8080/champion/Akali?foo=bar#skins',
                '14.9.1',
                'en_US',
            ),
        );
