...
import ChampionPicker from '../../builds/champion/ChampionPicker.vue'
import RuneBoard from '../../builds/runes/RuneBoard.vue'
import StepEditor from '../../builds/steps/StepEditor.vue'
import { useBuildEditor, type BuildEditorProps } from '../../builds/editor/useBuildEditor'
        ...
        <section id="forge-context" class="hextech-frame hx-corners forge-section">
            ...
            <div class="forge-context">
                <label class="block">
                    ...
                    <select v-model="gameVersion" name="game_version"
                            class="hx-select mt-1.5 w-full">
                        <option v-for="patch in versions" :key="patch" :value="patch">
                            {{ patch }}
                        </option>
                    </select>
                </label>
                <label class="block">
                    ...
                    <select v-model="gameMode" name="game_mode" class="hx-select mt-1.5 w-full">
                        <option v-for="option in gameModes" :key="option.value"
                                :value="option.value">
                            {{ option.label }}
                        </option>
                    </select>
                ...
                <label class="block">
                    ...
                    <select v-model="language" name="language" class="hx-select mt-1.5 w-full">
                        <option v-for="option in languages" :key="option.value"
                                :value="option.value">
                            {{ option.label }}
                        </option>
                    </select>
