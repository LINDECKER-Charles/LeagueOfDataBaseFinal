...
import { formatCounter, type ArmoryLabels, type UiLabels } from '../editor/editorLabels'
import {
    ITEM_CATEGORY_ALL,
    ITEM_CATEGORY_KEYS,
    matchesCategory,
...
<template>
    ...
    >
                    ...
                    >
                        <span class="armory-item__icon">
                            ...
                            <span
                                ...
                                :title="
                                    formatTemplate(labels.inStep, { count: countInStep(item.id) })
                                "
        ...
        <footer class="armory__foot">
            ...
            <button type="button" class="armory__done" @click="emit('close')">
                {{ labels.done }}
            </button>
        </footer>
    </dialog>
