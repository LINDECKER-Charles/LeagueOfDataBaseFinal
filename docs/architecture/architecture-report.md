...
- **Backend** : Symfony 7.4 LTS / PHP 8.5, `strict_types` + classes `final` généralisés.
- **Fetch** : micro-service **Go** (`go/fetcher`) = passerelle thin vers Data Dragon / CommunityDragon (SSRF allowlist, batch parallèle).
